...
A complete runnable implementation — file-or-stdin prompt input, configurable
concurrency, typed error handling — lives at
[`examples/batch-automation/`](https://github.com/ravi-hq/agent-on-demand/tree/main/examples/batch-automation)
in the repo.
