"""Public factory for building a SessionSpec from persisted ORM state.

This is the single source of truth for translating AgentSession + Agent +
Environment + SessionResource rows into the SessionSpec shape consumed by
provisioning and turn-execution code.
"""
